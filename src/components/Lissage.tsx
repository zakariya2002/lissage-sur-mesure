          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="space-y-8">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-[var(--color-bordeaux)] text-white font-medium text-[11px] uppercase tracking-[0.2em] hover:bg-[var(--color-bordeaux-dark,#5a1a2a)] transition-all duration-300"
              >
