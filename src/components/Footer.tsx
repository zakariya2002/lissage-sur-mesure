      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-[11px]"><a href="https://wa.me/33609775287" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-white transition-colors">+33 6 09 77 52 87</a></p>
          </div>
        </div>
