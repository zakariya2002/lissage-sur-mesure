  ...
  return (
    <section id="expertise-blonds" className="pt-16 md:pt-20 pb-14 md:pb-20 bg-white">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        {/* WhatsApp CTA */}
        <div className="border border-[var(--color-gray-200)] bg-[var(--color-gray-100)] p-10 md:p-16 lg:p-20">
          <div className="max-w-2xl mx-auto text-center">
            <div className="w-16 h-16 mx-auto mb-6 bg-[#25D366] rounded-full flex items-center justify-center">
            ...
            <h3 className="font-serif text-2xl md:text-3xl text-[var(--color-black)] mb-3">
              Échangeons sur WhatsApp
            </h3>
            <p className="text-[var(--color-gray-500)] text-sm leading-relaxed mb-8 max-w-sm mx-auto">
              Posez vos questions, obtenez des réponses rapides et personnalisées.
            </p>
            <a
              href="https://wa.me/33612287511?text=Bonjour%2C%20je%20souhaite%20en%20savoir%20plus%20sur%20la%20formation%20Lissage%20sur%20Mesure."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-10 py-4 bg-[#25D366] text-white font-medium text-[11px] uppercase tracking-[0.2em] hover:bg-[#1da851] transition-all duration-300"
            >
